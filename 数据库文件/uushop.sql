...
CREATE TABLE `address` (
  ...
  KEY `FKBB979BF46A78291A` (`uid`),
  CONSTRAINT `FK1ED033D46A78291A` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`),
  CONSTRAINT `FKBB979BF46A78291A` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`)
...
INSERT INTO `address` VALUES ('2', '递四方速递是否', '1', '的说法都是', '0', '1232321', '1', '1', '', '123213', '5');
...
CREATE TABLE `book` (
  ...
  KEY `FK2E3AE970860BB9` (`typeid`),
  CONSTRAINT `FK1FAF0970860BB9` FOREIGN KEY (`typeid`) REFERENCES `booktype` (`typeid`),
  CONSTRAINT `FK2E3AE970860BB9` FOREIGN KEY (`typeid`) REFERENCES `booktype` (`typeid`)
...
INSERT INTO `book` VALUES ('45', '萨达省', '递四方速递', '按时打算撒旦', '0', '0', '20180402160433_328.jpg', '20', '0', '323', '打算', '2012/2/15', '0', '0', '17');
...
INSERT INTO `collect_book` VALUES ('3', '5');
...
CREATE TABLE `comment` (
  ...
  KEY `FK38A5EE5FCEE2A487` (`bid`),
  KEY `FK38A5EE5F6A78291A` (`uid`),
  CONSTRAINT `FK38A5EE5F6A78291A` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`),
  CONSTRAINT `FK38A5EE5FCEE2A487` FOREIGN KEY (`bid`) REFERENCES `book` (`bid`),
...
INSERT INTO `comment` VALUES ('2', '2018-3-30 15:59:10', 'hgfhfg递四方速递斯蒂芬森爱仕达', '2018-3-30 16:28:21', '4', '5');
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES ('2', '这里是公告内容', '2018-4-2 16:01:58');
...
CREATE TABLE `orderitem` (
  ...
  KEY `FKE8B2AB61578E2E79` (`order_id`),
  CONSTRAINT `FK60163F61578E2E79` FOREIGN KEY (`order_id`) REFERENCES `order_table` (`order_id`),
  CONSTRAINT `FKE8B2AB61578E2E79` FOREIGN KEY (`order_id`) REFERENCES `order_table` (`order_id`)
...
INSERT INTO `orderitem` VALUES ('2', '1', '梦里花落知多少', '19', '4', '2');
INSERT INTO `orderitem` VALUES ('3', '1', '撒哈拉的故事', '19', '3', '2');
...
INSERT INTO `order_table` VALUES ('2', '2018-3-30 15:59:10', '5', '0', 'sfds ', '5', '43', '0', '38', '43', '2', '5');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'llq', '1', 'llq', 'c4ca4238a0b923820dcc509a6f75849b', '20180402162534_542.jpg', null, '0', 'GENERAL');
INSERT INTO `user` VALUES ('5', 'admin', '0', 'llq', 'c4ca4238a0b923820dcc509a6f75849b', '20180330160205_170.jpg', '0', '0', 'MANAGER');
INSERT INTO `user` VALUES ('6', '1193284480@qq.com', '0', '1193284480', '96e79218965eb72c92a549dd5a330112', 'default.jpg', '0', '0', 'GENERAL');
